        ...
        while True:
            if not self.input_queue.empty():
                ...
                with self.lock:
                    ...
                    healthy_thread=threading.Thread(target=self.write_csv,args=(self.success_queue,"Healthy Record"))
                    healthy_thread.start()
                   
                    unhealthy_thread=threading.Thread(target=self.write_csv,args=(self.fail_queue,"UnHealthy Record"))                    
